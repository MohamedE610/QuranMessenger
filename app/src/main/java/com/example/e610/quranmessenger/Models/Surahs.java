...
public class Surahs implements Serializable
{
    ...
    private final static long serialVersionUID = 5979646806901684092L;
     ...
     */
    public Surahs(Integer number, String name, String englishName, String englishNameTranslation, String revelationType, Integer numberOfAyahs) {
        super();
        this.number = number;
        this.name = name;
